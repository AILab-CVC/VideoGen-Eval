...
* We assign an ID to each case, and the input text, the names of input images and videos correspond to the ID. The results generated by different models are named as `model_name+id.mp4`. Please refer to the [prompt](https://ailab-cvc.github.io/VideoGen-Eval/specifc_model/prompt.html).
=======
...
>>>>>>> be84252272546c3590303865fe7f214922bb6a07
